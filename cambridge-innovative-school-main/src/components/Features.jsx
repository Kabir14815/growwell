  ...
  return (
    <div>
        <div class="content-side">
          <h1 className='mb-10 w-[90%] sm:w-[70%] md:w-[50%] m-auto font-semibold text-zinc-800 text-[1.5rem] sm:text-[4.8vw] md:text-[3.8vw] text-center'>Welcome to <span className='text-[#ff9900]'>Growell</span></h1>
